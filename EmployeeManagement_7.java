...
abstract class Employee implements Serializable {
    ...
    public static void serializeData() {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("employees.ser"))) {
            ...
            System.out.println("Employee Map Serialized");
        } catch (IOException e) {
            System.out.println(e.getMessage());
        }
    }
    
    public static HashMap<Integer, Employee> deserializeData() {
    	HashMap<Integer, Employee> empMapDeserialized = new HashMap<>(); 
    	File f = new File("employees.ser");
    	try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(f))) {
        	empMapDeserialized = (HashMap<Integer, Employee>) ois.readObject();
        	System.out.println("Employee Map Deserialized");
    	} catch (Exception e) {
        	System.out.println(e.getMessage());
    	}
    	return empMapDeserialized;
     }
...
public class EmployeeManagement_7 {
	...
	*/
	Employee.empMap=Employee.deserializeData();
        Scanner sc = new Scanner(System.in);
        while (true) {
            System.out.println("--------------------");
